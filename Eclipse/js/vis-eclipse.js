...
function initEclipse(){
        ...
        //Creation of vis DataSets for Nodes and Edges
         ...
         {id: 0, product: "Eclipse",release:"Eclipse 3.0",image: './img/Merry_Christmas_and_Happy_New_Year-4792.svg', shape: 'image'},    
         {id: 1, product: "Eclipse",release:"Eclipse 3.1",image: './img/Christmas_train_4546.svg', shape: 'image'},
         {id: 2, product: "Eclipse",release:"Callisto",image: './img/Winter_stars_4530.svg', shape: 'image'},
         {id: 3, product: "Eclipse",release:"Europ",image: './img/Snowflakes-4740.svg', shape: 'image'},
         {id: 4, product: "Eclipse",release:"Ganymede",image: './img/gifts-4701.svg', shape: 'image'},
         {id: 5, product: "Eclipse",release:"Galileo",image: './img/Christmas_bear-4707.svg', shape: 'image'},
         {id: 6, product: "Eclipse",release:"Helios",image: './img/gifts-4701.svg', shape: 'image'},
         {id: 7, product: "Eclipse",release:"Indigo",image: './img/Snowflakes-4740.svg', shape: 'image'},
         {id: 8, product: "Eclipse",release:"Juno",image: './img/Snowflakes-4740.svg', shape: 'image'},
         {id: 9, product: "Eclipse",release:"Kepler",image: './img/Snowflakes-4740.svg', shape: 'image'},
         {id: 10, product: "Eclipse",release:"Luna",image: './img/gifts-4701.svg', shape: 'image'},
         {id: 11, product: "Eclipse",release:"Mars",image: './img/Snowflakes-4740.svg', shape: 'image'},
         {id: 12, product: "Eclipse",release:"Neon",image: './img/gifts-4701.svg', shape: 'image'},
         {id: 13, product: "Eclipse",release:"Oxygen",image: './img/Snowflakes-4740.svg', shape: 'image'}
